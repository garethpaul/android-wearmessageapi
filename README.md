...
two application modules disable both PNG crunching and AGP 1.1.0's queued PNG
implementation because dependency preprocessing can otherwise fail on Play
Services nine-patch resources; AAPT still packages and validates those
resources during the same Gradle gates. The
